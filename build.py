...
<!-- Refer & Earn — Rupeewa App -->
<section class="refer-hero" aria-label="Refer & Earn">
  <a href="https://rupeewa.com/?invite=MNTAYR" target="_blank" rel="noopener" class="refer-hero-link">
    <img src="refer-earn.jpg" alt="Rupeewa App" class="refer-hero-img">
    <div class="refer-hero-text">
      <span class="refer-hero-title">🔥 <strong>Rupeewa App</strong> — Refer & Earn!</span>
      <span class="refer-hero-desc">📱 WhatsApp tasks karo aur ₹100+ withdraw karo! Same as Athena App. Limited time offer — join now!</span>
      <span class="refer-hero-cta">👉 Join Now & Start Earning!</span>
    </div>
  </a>
</section>
